...
class Hello(object):
    ...
    def index_orig(self, toprint="Hello World!"):
        return toprint
    #@+node:2014fall.20141212095015.1779: *3* index
    @cherrypy.expose
    def index(self, toprint="學號：40223127"):
        return toprint
    #@+node:2015.20150428102325.1805: *3* spur
    @cherrypy.expose
    # coding=utf-8
    # N 為齒數, M 為模數, P 為壓力角
    def spur(self, N, M, P):
    ...
    '''
        ...
        return outstring
    #@+node:2014fall.20141215194146.1791: *3* index1
    @cherrypy.expose
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150407093738.1748: *3* mygeartest_control
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def mygeartest_control(self, N=20, M=5, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
